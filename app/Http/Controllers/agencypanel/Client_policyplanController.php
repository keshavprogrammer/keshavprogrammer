...
class Client_policyplanController extends Controller
{
    ...
    public function manage($cid) {
        ...
        return view('agencypanel.manageclientpolicy', compact('data', 'cid','client'));
    }
    ...
    public function add($cid) {
    	...
    	$data = array('type'=>'add', 'cid'=>$cid, 'agency_id'=>Auth::id());
    ...
    public function save(Request $request) {
        ...
        if ($validator->fails()) { 
            ...
            $data = array('type'=>'add', 'input'=>$input, 'cid'=>$input['client_id'], 'agency_id'=>Auth::id(),  'error'=>$validator->messages());
    ...
    public function edit($cid, $id) {
        ...
        $data = array('type'=>'edit','input'=>$input, 'cid'=>$cid, 'agency_id'=>Auth::id());
    	return view('agencypanel.addclientpolicy', compact('data','overrideProducerCode','lineOfBusiness',
            'ratingState','company','originalAgentCode','policyStatus','billingType','referalPartnerCode',
            'leadSource','department','serviceTeam','insuredInformationPl','insuredInformationCl','additionalInterests'
        ));
	...
	public function update(Request $request) {
        ...
        if ($validator->fails()) {
            ...
            $data = array('type'=>'Edit', 'input'=>$input, 'cid'=>$input['client_id'], 'agency_id'=>Auth::id(), 'error'=>$validator->messages());
            return view('agencypanel.addclientpolicy', compact('data','overrideProducerCode','lineOfBusiness',
                'ratingState','company','originalAgentCode','policyStatus','billingType','referalPartnerCode',
                'leadSource','department','serviceTeam','insuredInformationPl','insuredInformationCl','additionalInterests')
            );
    ...
    public function ajaxGetPolicyByPolicytypeId(Request $request) {
        $input = $request->all();
        $data = Policyplan::where("policy_type_id", "=",  $input['id'])->where("agency_id", "=", Auth::id())->pluck('title', 'id');
