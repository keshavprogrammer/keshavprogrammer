...
class Client_policyplanController extends Controller
{
    ...
    public function manage($cid) {
        ...
        return view('subagentpanel.manageclientpolicy', compact('data', 'cid','client'));
    }
    ...
    public function add($cid) {
    	...
    	return view('subagentpanel.addclientpolicy', compact('data','overrideProducerCode','lineOfBusiness',
    ...
    public function save(Request $request) {
        ...
        if($CP->id>0) {
            return redirect('/subagentpanel/manageclientpolicy/'.$input['client_id'])->with('success', 'Created successfully.');
        } else {
            return redirect('/subagentpanel/addclientpolicy/'.$input['client_id'])->withErrors(['Error creating record. Please try again.']);
        }
    }
	...
	public function update(Request $request) {
        ...
        return redirect('/subagentpanel/manageclientpolicy/'.$input['client_id'])->with('success', 'Updated successfully.');

	}
    
    public function delete($id) {
        ClientPolicy::where('id','=',$id)->delete();
        return redirect('/subagentpanel/manageclientpolicy/'.$input['client_id'])->with('success', 'Deleted successfully.');
    }
