...
class SubagentController extends Controller
{
    ...
    public function manage() {
        $data = Subagent::where("agent_id", "=", Auth::id())->paginate($this->pagination);
        return view('agentpanel.managesubagent', compact('data'));
    }
    ...
    public function subagentsinglesms(Request $request) {
        ...
        if($sentResponse->sid != ''){
            ...
            return redirect()->route('agentpanel.subagent.manage')->with('success', 'SMS sent successfully.');
        }
        else{
            return redirect()->route('agentpanel.subagent.manage')->withErrors(['SMS is not sent']);
        }
    }
    public function search(Request $request) {
        ...
        $data->appends($input);
        return view('agentpanel.manageagency', compact('data'));
    }
    ...
    public function add() {
        ...
        return view('agentpanel.addsubagent', compact('data'));
    }
    ...
    public function save(Request $request) {
        ...
        if($agency->id>0) {
            return redirect()->route('agentpanel.subagent.manage')->with('success', 'Created successfully.');
        } else {
            return redirect()->route('agentpanel.subagent.add')->withErrors(['Error creating record. Please try again.']);
        }
    }
    ...
    public function update(Request $request) {
        ...
        return redirect()->route('agentpanel.subagent.manage')->with('success', 'Updated successfully.');
    ...
    public function delete($id) {
        ...
        return redirect()->route('agentpanel.subagent.manage')->with('success', 'Deleted successfully.');
    }
